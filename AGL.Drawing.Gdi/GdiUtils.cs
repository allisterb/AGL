...
namespace AGL.Drawing.Gdi {
    public class GdiUtils {
        public static void DrawFromGraph(System.DrawingCore.Rectangle clientRectangle, GeometryGraph geometryGraph, Graphics graphics) {
        ...
        public static System.DrawingCore.Point MsaglPointToDrawingPoint(Point point) {
            return new System.DrawingCore.Point((int)point.X, (int)point.Y);
        }
